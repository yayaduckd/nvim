return {
    ...
    config = function()
        ...
        mason_dap.setup({
            ensure_installed = { "cppdbg", "codelldb", "lldb" },
        ...
        -- Configurations
        local lldbinit_cmd = "command source " .. vim.fn.expand("~/.lldbinit")

        dap.configurations = {
            c = {
                {
                    name = "Launch file (codelldb)",
                    type = "codelldb", -- Switched to codelldb
                    request = "launch",
                    program = function()
                ...
                {
                    name = "Attach to lldbserver :1234 (codelldb)",
                    type = "codelldb",
                    request = "attach",
